...
el_gamal_::el_gamal_ () : asymmetric_t (asymmetric::EL_GAMAL, "ElGamal") { }

el_gamal_::private_key_t::private_key_t (const long_number_t& x_, const long_number_t& p_, const long_number_t& g_) : x (x_), p (p_), g (g_) { }
el_gamal_::private_key_t::~private_key_t () { }
long_number_t el_gamal_::private_key_t::decrypt (const asymmetric_t::encrypted_t& c) const {
...
wrapper<asymmetric_t::sign_t> el_gamal_::private_key_t::sign (const long_number_t& m) const {
	while (true) {
...
el_gamal_::public_key_t::public_key_t (const long_number_t& p_, const long_number_t& g_, const long_number_t& y_) : p (p_), g (g_), y (y_) { }
el_gamal_::public_key_t::~public_key_t () { }
wrapper<asymmetric_t::encrypted_t> el_gamal_::public_key_t::encrypt (const long_number_t& m) const {
	long_number_t k = gen_session_key (p, true);
...
bool el_gamal_::public_key_t::check_sign (const long_number_t& m, const asymmetric_t::sign_t& sign) const {
...
std::pair<wrapper<asymmetric_t::private_key_t>, wrapper<asymmetric_t::public_key_t>> el_gamal_::generate_keys (_size_t bits) const {
...
const el_gamal_ el_gamal_::instance {};
