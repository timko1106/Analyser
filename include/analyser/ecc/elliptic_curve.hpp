...
class elliptic_curve final : public curve {
	...
	const point G;
	const long_number_t n;
	elliptic_curve (const std::string& _name, const point& _G, const long_number_t& _p, const long_number_t& _a, const long_number_t& _b, const long_number_t& _n);
public:
	...
	static const elliptic_curve* register_curve (const std::string& _name, const point& g, const long_number_t& p, const long_number_t& a, const long_number_t& b, const long_number_t& n);
